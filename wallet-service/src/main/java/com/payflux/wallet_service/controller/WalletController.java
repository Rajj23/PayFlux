package com.payflux.wallet_service.controller;

import com.payflux.wallet_service.dto.*;
...
public class WalletController {
    ...
    public ResponseEntity<HoldResponse> placeHold(@PathVariable String holdReference){
